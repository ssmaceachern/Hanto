...
public class DeltaHantoTest
{
	...
	@Test //1
	public void bluePlacesButterflyFirstTest() throws HantoException
	{
	...
	public void attemptToMoveAfterGameIsOverTest() throws HantoException
	{
	...
	@Test //5
	public void sparrowFliesMoreThanOneSpaceTest() throws HantoException
	{
		final PieceLocationPair[] board = new PieceLocationPair[] {
			    plPair(BLUE, BUTTERFLY, 0, 0), plPair(RED, BUTTERFLY, 0, 1),
			    plPair(BLUE, SPARROW, -1, 0), plPair(RED, SPARROW, 1, -1),
	...
	public void sparrowFliesToInvalidLocationTest() throws HantoException
	{
		final PieceLocationPair[] board = new PieceLocationPair[] {
			    plPair(BLUE, BUTTERFLY, 0, 0), plPair(RED, BUTTERFLY, 0, 1),
			    plPair(BLUE, SPARROW, -1, 0), plPair(RED, SPARROW, 1, -1)
	...
	public void crabWalksAndCreatesDisconnectedConfigurationTest() throws HantoException
	{
		final PieceLocationPair[] board = new PieceLocationPair[] {
			    plPair(BLUE, BUTTERFLY, 0, 0), plPair(RED, BUTTERFLY, 0, 1),
	...
	@Test //9
	public void moveByFlyingTest() throws HantoException
	{
